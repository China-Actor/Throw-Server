...
//	private static final int ALLOC_SIZE = 300;
	...
	private void taskDeleteLog()
	{
		...
		int firstDate=0;//Integer.parseInt(DateTools.getBeforeDay(new Date(),-deleteDateNum).replaceAll("-", ""));
	...
	private String getWriterTitle()
	{
		...
		String idName = null;//DateTools.getCurrentTimeMSString() + " [" + t.getName()+" <" + t.getId() + ">] ";
		return idName;
	}
