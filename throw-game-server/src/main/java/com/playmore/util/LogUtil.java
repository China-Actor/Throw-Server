...
public class LogUtil 
{
	...
	private static LogFile ERR_LF = new LogFile("err" , 7),
	INFO_LF = new LogFile("info" , 7),
	DEBUG_LF = new LogFile("debug" , 7),
	PROTOCOL_LF = new LogFile("protocol" , 7),
	EVAL_LF = new LogFile("eval" , 7);
...
//		}
	...
	public static void eval(String content) 
	{
		EVAL_LF.writeFile(content);
	}
