...
//	 * @param res
//	 */
//	public void reward(ISession session, @CMD(cmd = 30) RewardItem reward) {
...
/*
 * Location:
 * G:\guajiProject\guanji\ProjectS\lib\lib\Netty_Lib-0.0.1-SNAPSHOT.jar!\handler
 * \c2s\LoginHandler.class Java compiler version: 7 (51.0) JD-Core Version:
 * 1.0.7
 */