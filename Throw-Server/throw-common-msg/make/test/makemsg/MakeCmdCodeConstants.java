...
public class MakeCmdCodeConstants {
	...
	public static void main(String[] str) {
		...
		try {
			...
			// base model 所使用的包名
			String baseModelPackageName = "com.playmore.dbobject.staticdb.cmdcode";
			// base model 文件保存路径
			String baseModelOutputDir = GetPath.getLocalPath() + "/src/com/playmore/dbobject/staticdb/cmdcode";
			System.out.println("baseModelOutputDir="+baseModelOutputDir);
			
			CmdCodeConstantsGenerator generator = new CmdCodeConstantsGenerator(baseModelPackageName, baseModelOutputDir);
			generator.generate();
		} catch (Exception e) {
			e.printStackTrace();
		}
