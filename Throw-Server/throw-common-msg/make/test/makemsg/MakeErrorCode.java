...
public class MakeErrorCode {
	...
	public static void main(String[] str) {
		...
		try {
			...
			// base model 所使用的包名
			String baseModelPackageName = "com.playmore.dbobject.staticdb.errorcode";
			// base model 文件保存路径
			String baseModelOutputDir = GetPath.getLocalPath() + "/src/com/playmore/dbobject/staticdb/errorcode";
			System.out.println("baseModelOutputDir="+baseModelOutputDir);
			
			ErrorCodeSGenerator generator = new ErrorCodeSGenerator(baseModelPackageName, baseModelOutputDir);
			generator.generate();
		} catch (Exception e) {
			e.printStackTrace();
		}
