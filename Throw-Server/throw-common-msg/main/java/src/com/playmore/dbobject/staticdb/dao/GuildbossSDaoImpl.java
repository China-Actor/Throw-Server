...
import main.java.com.playmore.dbobject.staticdb.GuildbossS;
...
public class GuildbossSDaoImpl extends SinglePrimaryKeyDBDaoImpl<GuildbossS>{
	...
	private static final GuildbossSDaoImpl DEFAULT = new	GuildbossSDaoImpl();
	public static GuildbossSDaoImpl getDefault() {
		return DEFAULT;
	}
