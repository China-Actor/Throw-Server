...
import main.java.com.playmore.dbobject.staticdb.CopymasterS;
...
public class CopymasterSDaoImpl extends SinglePrimaryKeyDBDaoImpl<CopymasterS>{
	...
	private static final CopymasterSDaoImpl DEFAULT = new	CopymasterSDaoImpl();
	public static CopymasterSDaoImpl getDefault() {
		return DEFAULT;
	}
