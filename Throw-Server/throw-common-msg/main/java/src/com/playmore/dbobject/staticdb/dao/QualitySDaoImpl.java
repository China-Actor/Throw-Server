...
import main.java.com.playmore.dbobject.staticdb.QualityS;
...
public class QualitySDaoImpl extends SinglePrimaryKeyDBDaoImpl<QualityS>{
	...
	private static final QualitySDaoImpl DEFAULT = new	QualitySDaoImpl();
	public static QualitySDaoImpl getDefault() {
		return DEFAULT;
	}
