...
public class PlayerFormation implements Serializable {
	...
	public String toString() {
		return "PlayerFormation [id=" + id + " ,playerId=" + playerId + " ,type=" + type + " ,slot1Pos=" + slot1Pos + " ,slot1Card=" + slot1Card + " ,slot2Pos=" + slot2Pos + " ,slot2Card=" + slot2Card + " ,slot3Pos=" + slot3Pos + " ,slot3Card=" + slot3Card + " ,slot4Pos=" + slot4Pos + " ,slot4Card=" + slot4Card + " ,slot5Pos=" + slot5Pos + " ,slot5Card=" + slot5Card + " ,useStrategy=" + useStrategy + " ,power=" + power + " ,skillId=" + skillId+ "]";
	}
}
