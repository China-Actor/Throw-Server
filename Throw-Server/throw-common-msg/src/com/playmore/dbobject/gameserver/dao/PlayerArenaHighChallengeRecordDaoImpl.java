...
public class PlayerArenaHighChallengeRecordDaoImpl extends SinglePrimaryKeyDBDaoImpl<PlayerArenaHighChallengeRecord>{
	...
	private static final PlayerArenaHighChallengeRecordDaoImpl DEFAULT = new	PlayerArenaHighChallengeRecordDaoImpl();
	public static PlayerArenaHighChallengeRecordDaoImpl getDefault() {
		return DEFAULT;
	}
