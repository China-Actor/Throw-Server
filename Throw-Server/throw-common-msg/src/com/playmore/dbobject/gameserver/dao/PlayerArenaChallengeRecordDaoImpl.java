...
public class PlayerArenaChallengeRecordDaoImpl extends SinglePrimaryKeyDBDaoImpl<PlayerArenaChallengeRecord>{
	...
	private static final PlayerArenaChallengeRecordDaoImpl DEFAULT = new	PlayerArenaChallengeRecordDaoImpl();
	public static PlayerArenaChallengeRecordDaoImpl getDefault() {
		return DEFAULT;
	}
