...
import main.java.com.playmore.dbobject.staticdb.BossstageS;
...
public class BossstageSDaoImpl extends SinglePrimaryKeyDBDaoImpl<BossstageS>{
	...
	private static final BossstageSDaoImpl DEFAULT = new	BossstageSDaoImpl();
	public static BossstageSDaoImpl getDefault() {
		return DEFAULT;
	}
