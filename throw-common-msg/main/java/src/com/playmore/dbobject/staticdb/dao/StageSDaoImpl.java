...
import main.java.com.playmore.dbobject.staticdb.StageS;
...
public class StageSDaoImpl extends SinglePrimaryKeyDBDaoImpl<StageS>{
	...
	private static final StageSDaoImpl DEFAULT = new	StageSDaoImpl();
	public static StageSDaoImpl getDefault() {
		return DEFAULT;
	}
